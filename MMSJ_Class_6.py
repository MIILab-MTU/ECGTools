...
if __name__ == '__main__':
    ...
    for train_index, test_index in kf.split(x_train, y_train):
        ...
        plt.savefig("Receiver_operating_characteristic_Train.tif", dpi=300)
        plt.show()
        ...
        plt.title('Receiver operating characteristic')
        plt.legend(loc='lower right')
        plt.savefig("Receiver_operating_characteristic_Test.tif", dpi=300)
        plt.show()
        ...
        # history.loss_plot('epoch') Plot_epoch